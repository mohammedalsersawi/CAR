                            ...
                            <div class="card-body">
                                <a href="javascript:void(0);" class="brand-logo">
                                      <span class="brand-logo"><img alt="logo" src="{{ asset('dashboard/app-assets/images/logo/Group 16027.png') }}"
                                                                    style="max-width: 50% !important; margin: 0 auto; display: flex;" />
                        </span>
                                ...
                                <form class="auth-login-form mt-2" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group">
                                        <label for="login-phone" class="form-label">@lang('phone')</label>
                                        <label class="form-label" for="userphone">@lang('phone')</label>
                                        <input type="tel" name="phone" :value="old('phone')" required
                                            class="form-control" id="userphone" placeholder="@lang('phone')">
                                        @if ($errors->has('phone'))
