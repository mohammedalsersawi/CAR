                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <select name="engine_uuid" id="s_engine"
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <select name="transmission_uuid" id="s_transmission"
                                                        ...
                                                        aria-hidden="true">
                                                    <option selected
                                                            disabled>@lang('select') @lang('Transmission')</option>
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <select name="color_interior_uuid" id="s_color_interior"
                                                        ...
                                                        aria-hidden="true">
                                                    <option selected
                                                            disabled>@lang('select') @lang('color_interior')</option>
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <select name="color_exterior_uuid" id="s_color_exterior"
                                                        ...
                                                        aria-hidden="true">
                                                    <option selected
                                                            disabled>@lang('select') @lang('color_exterior')</option>
                                                    @foreach ($ColorCar as $itemm)
    ...
    <div class="modal fade" class="full-modal-stem" id="full-modal-stem" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('user.ads.store') }}" method="POST" id="add-mode-form" class="add-mode-form"
    ...
    <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('user.ads.update') }}" method="POST" id="form_edit" class="form_edit"
                      enctype="multipart/form-data">
                    @csrf
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        var table = $('#datatable').DataTable({
            ...
            ajax: {
                url: '{{ route('user.ads.getData', app()->getLocale()) }}',
                data: function (d) {
                    d.phone = $('#s_phone').val();
