...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::post('ads/car',[\App\Http\Controllers\Api\Cars\CarsController::class,'addcar']);
    Route::get('/show/car/{uuid}',[\App\Http\Controllers\Api\Cars\CarsController::class,'getonecar']);
